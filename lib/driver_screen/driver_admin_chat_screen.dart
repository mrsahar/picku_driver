...
class DriverAdminChatScreen extends GetView<DriverAdminChatController> {
  const DriverAdminChatScreen({super.key});
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.only(
                  ...
                  bottomLeft: Radius.circular(isDriver ? 20 : 4),
                  bottomRight: Radius.circular(isDriver ? 4 : 20),
                ),
                boxShadow: [
                  BoxShadow(
